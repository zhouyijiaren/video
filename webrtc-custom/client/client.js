...
async function loadMediasoupClient() {
  ...
  const urls = [
    ...
    'https://cdn.jsdelivr.net/npm/mediasoup-client@3.18.3/mediasoup-client.min.js',
    'https://unpkg.com/mediasoup-client@3.18.3/mediasoup-client.min.js',
  ];
  ...
  throw new Error('mediasoup-client failed to load from CDN');
}
